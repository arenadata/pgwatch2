...
const mockRows = [
  ...
  {
    id: 3,
    passwordEncryption: 'custom-encryption'
  }
];
  ...
  const columns: GridColDef[] = [
    ...
    },
    {
      ...
      renderCell: (params: GridRenderCellParams<string>) => (
        params.value ? <Typography>{params.value}</Typography> : <SimpleTextField param={params.value} placeholder="Type unique name here" id={`unique-name-${params.row.id}`} type="text" />
      ),
      width: 200,
    ...
    },
    {
      ...
      type: 'singleSelect',
      valueOptions: ['plain-text', 'aes-gcm-256'],
      editable: true,
      width: 200,
    ...
    },
    {
      ...
      width: 160,
      renderCell: (params: GridRenderCellParams<string>) => (
        <ActionsComponent handleAlertOpen={handleAlertOpen} uniqueName={params.row.uniqueName} />
      )
    }
  ];
